...
public class EnderBow extends ItemBow {
    public EnderBow() {
        ...
        addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter() {
            ...
            public float apply(ItemStack stack, @Nullable World worldIn, @Nullable EntityLivingBase entityIn) {
                ...
                else return entityIn.getActiveItemStack().getItem() != DFItems.ENDER_BOW ? 0.0F : (stack.getMaxItemUseDuration() - entityIn.getItemInUseCount()) / 20.0F;
            }
        });
    ...
    @Override
    public boolean isArrow(ItemStack is) {
        if(is != null) {
            Item i = is.getItem();
            Class<?> clazz = EnderArrow.class;
        ...
        if (entityLiving instanceof EntityPlayer) {
            ...
            if (!itemstack.isEmpty() || flag) {
                if (itemstack.isEmpty()) {
                    itemstack = new ItemStack(DFItems.ENDER_ARROW);
                }
