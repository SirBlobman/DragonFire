...
public class ModelCustomBoat extends ModelBase implements IMultipassModel
{
    ...
    public void render(Entity entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        EntityCustomBoat EntityCustomBoat = (EntityCustomBoat)entityIn;
        ...
        this.renderPaddle(EntityCustomBoat, 0, scale, limbSwing);
        this.renderPaddle(EntityCustomBoat, 1, scale, limbSwing);
    }
    ...
    protected void renderPaddle(EntityCustomBoat boat, int paddle, float scale, float limbSwing)
    {
