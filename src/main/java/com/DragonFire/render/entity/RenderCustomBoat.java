...
public class RenderCustomBoat extends Render<EntityCustomBoat> {
     ...
     */
    public void doRender(EntityCustomBoat entity, double x, double y, double z, float entityYaw, float partialTicks) {
    ...
    public void setupRotation(EntityCustomBoat p_188311_1_, float p_188311_2_, float p_188311_3_) {
        ...
        if (f > 0.0F) {
            GlStateManager.rotate(MathHelper.sin(f) * f * f1 / 10.0F * p_188311_1_.getForwardDirection(), 1.0F,
                    0.0F, 0.0F);
        }
    ...
    public void renderMultipass(EntityCustomBoat p_188300_1_, double p_188300_2_, double p_188300_4_, double p_188300_6_,
